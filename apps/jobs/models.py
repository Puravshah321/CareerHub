...
from apps.quiz.models import GlobalRanking
...
class Application(models.Model):
    ...
    GlobalRanking = models.ForeignKey(GlobalRanking, on_delete=models.CASCADE,null=True,blank=True , related_name='applications')
